...
do
		...
		ipt6ables -I OUTPUT -o  SH1C-eth1 -p udp --dport 33434:33524 -m state --state NEW -j ACCEPT
		#Restrict incoming SSH to the local network
		ip6tables -A INPUT -i SH1C-eth1 -p tcp -s fd00:${a}:3::6/48 --dport 22 -j ACCEPT
