...
for router, configs_firewall in data.items():
	...
	if "lans" in configs_firewall:
		...
		router_firewall_config_file.write(
				...
				"ip6tables -A FORWARD -p tcp -s fd00:${a}:3:"+lan_rules[0]+"::"+configs_firewall["router_id"]+"/64  -d fd00:${a}:3:"+lan_rules[1]+"::"+configs_firewall["router_id"]+"/64 --dport 22 -j ACCEPT\n\n"
				"# Allow SMTP for students and staff members\n"
				"ip6tables -A FORWARD -p tcp -s fd00:${a}:3:"+lan_rules[0]+"::"+configs_firewall["router_id"]+"/64  -d fd00:${a}:3:"+lan_rules[1]+"::"+configs_firewall["router_id"]+"/64 --dport 25 -j ACCEPT\n\n"
				"# Allow HTTP and HTTPS for students and staff members\n"
				"ip6tables -A FORWARD -p tcp -s fd00:${a}:3:"+lan_rules[0]+"::"+configs_firewall["router_id"]+"/64  -d fd00:${a}:3:"+lan_rules[1]+"::"+configs_firewall["router_id"]+"/64 --dport 80 -j ACCEPT\n"
				"ip6tables -A FORWARD -p tcp -s fd00:${a}:3:"+lan_rules[0]+"::"+configs_firewall["router_id"]+"/64  -d fd00:${a}:3:"+lan_rules[1]+"::"+configs_firewall["router_id"]+"/64 --dport 443 -j ACCEPT\n\n"
