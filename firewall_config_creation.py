...
for router, configs_firewall in data.items():
	...
	router_firewall_config_file.write(
		...
		"ip6tables -A INPUT -p icmpv6 -m limit --limit 5/min -j ACCEPT\n"
		"ip6tables -A OUTPUT -p icmpv6 -m limit --limit 5/min -j ACCEPT\n"
		...
		"#ip6tables -A INPUT -p icmpv6 --icmpv6-type 8 -m limit --limit 5/min -j ACCEPT\n"
		"#ip6tables -A OUTPUT -p icmpv6 --icmpv6-type 0 -m limit --limit 5/min -j ACCEPT\n"
